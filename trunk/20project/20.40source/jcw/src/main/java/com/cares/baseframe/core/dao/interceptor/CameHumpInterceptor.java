package com.cares.baseframe.core.dao.interceptor;
...
/**
 * MyBatis Map类型大写下划线Key转小写驼峰形式 改为拦截ResultSetHandler，更简单的，而且可以避免一级缓存导致重复转换出错
 */
...
public class CameHumpInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		System.out.println("--MyBatis Map类型大写下划线Key转小写驼峰形式 改为拦截ResultSetHandler--:list:"+list);
